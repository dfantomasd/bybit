...
class ExecutionEngine:
    ...
    async def _submit_locked(
        ...
        # P0.2/P0.3: Block duplicate entries for the same symbol while its
        # prior entry is pending. A global pending cap still limits burstiness,
        # but unrelated symbols should continue collecting SHADOW/PAPER data.
        ...
        # SHADOW probes are paper-collection instruments. They already pass a
        # strategy-local cost-aware pre-gate, but applying the live-wide engine
        # hurdle as well can starve paper outcomes entirely. Keep the strict
        # engine gate for normal strategies and all LIVE entries; let SHADOW
        # probes collect data after their own probe-specific economics pass.
    ...
    async def cancel_all_open_orders(self) -> int:
        """Cancel every open exchange order. Used by emergency stop."""
