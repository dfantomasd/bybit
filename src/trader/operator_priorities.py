...
def safety_priority_text() -> str:
    ...
    return "\n".join(
        [
            ...
            "4. <b>Фильтры сигналов</b> — bucket/symbol gates, shadow loss guard, MTF, model gate.",
...
def signal_filter_priority_text() -> str:
    ...
    return "\n".join(
        [
            ...
            "4. <b>MTF trend confirm</b> — для LIVE: 5m/15m должны согласоваться с 1m трендом.",
            "5. <b>Model gate (CANARY)</b> — ML-фильтр только при доказанном lift; в SHADOW — наблюдение.",
            "6. <b>RiskManager.validate</b> — финальная проверка размера и лимитов перед ордером.",
            "",
