...
def test_position_sizer_rejects_missing_liquidity_when_required():
    info = InstrumentInfo(
        symbol="UNKNOWNUSDT",
        market_type=MarketType.LINEAR,
        base_coin="UNKNOWN",
    ...
    sizer = PositionSizer(get_risk_limits(RiskProfile.MODERATE), info, require_liquidity=True)
    ...
    assert reason == "missing liquidity turnover_24h"
