...
def test_logreg_high_c_less_regularized() -> None:
    ...
    model_tight = ChallengerModel(version="v", feature_names=["f0", "f1", "f2"], model_type="LOGREG", model_params={"C": 0.01})
    model_loose = ChallengerModel(version="v", feature_names=["f0", "f1", "f2"], model_type="LOGREG", model_params={"C": 100.0})
